...
4. **Verify** — typecheck and test before committing. Fix any failures before proceeding.
...
6. **Pull request** — create a pull request for the issue explaining what was done.
